...
import 'package:wing_bank/models/data/cartItem-login.dart';
import 'package:wing_bank/models/lists/list-item-login.dart';
import 'package:wing_bank/screen/Login/auth/PIN.dart';
import 'package:wing_bank/screen/Login/home/CardCustom.dart';
import 'package:wing_bank/screen/Login/home/drawer-page.dart';
import 'package:wing_bank/screen/Login/home/myQRcode.dart';
import 'package:wing_bank/screen/Login/home/promotionLog.dart';
import 'package:wing_bank/screen/Login/pages/Notification/notification.dart';
import 'package:wing_bank/screen/Login/pages/external-app-wing/wingAgri/wing-agri.dart';
import 'package:wing_bank/screen/Login/pages/external-app-wing/wingCoin/wing-coin.dart';
import 'package:wing_bank/screen/Login/pages/external-app-wing/wingMarket/wing-Market.dart';
...
class _HomeBodyLoginState extends State<HomeBodyLogin> {
  ...
  void _showPINScreen(BuildContext context, Widget route) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => PIN(route: route)),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Image.asset("assets/icons/wing-logo-white.png", height: 55),
        actions: [
          IconButton(
            onPressed: () {
              Navigator.push(
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const WingCoin()),
                    );
                  },
                  child: Image.asset(
