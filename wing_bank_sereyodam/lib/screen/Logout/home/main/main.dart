...
import 'package:wing_bank/screen/Logout/home/main/changeLanguage.dart';
...
class _MyHomePageState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        Scaffold(appBar: appBarScreen(context), body: const BodyScreen()),
      ],
    );
  }
  ...
  AppBar appBarScreen(context) {
    return AppBar(
      ...
      title: Row(
        ...
        children: [
          Image.asset("assets/icons/wing-logo-white.png", height: 50),
          GestureDetector(
